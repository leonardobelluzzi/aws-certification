...
Amazon CloudWatch Logs to monitor, store, and access your log files from [Amazon Elastic Compute Cloud (Amazon EC2)](EC2.md) instances, [AWS CloudTrail](../Concepts/AWS%20CloudTrail.md), [Route 53](Amazon%20Route%2053.md), and **other sources such as on-premises servers**.
