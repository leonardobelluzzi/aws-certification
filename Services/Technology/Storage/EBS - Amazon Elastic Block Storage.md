Amazon EBS is an easy-to-use, high-performance, block-storage service designed for use with [Amazon EC2](../../EC2.md) instances. It is a block-storage service and not a file storage service.




Amazon Elastic Block Store (EBS) is an easy to use, high-performance block storage service designed for use with [Amazon EC2](../../EC2.md) for both throughput and transaction-intensive workloads at any scale.
